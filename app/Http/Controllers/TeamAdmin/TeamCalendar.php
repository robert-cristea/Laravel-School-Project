...
class TeamCalendar extends Controller 
{
    /**
    ...
    ////////////////////////////////// Team Calender /////////////////////////////
    // Engagement
    public function showMyteamEngageGeneral(Request $request){
        $id = Auth::user()->id;
        ...
        $video_views = User_activities_videos::Join('vieva_team_members', 'vieva_team_members.user_id', '=', 'vieva_user_activities_videos.user_id')
                    ->where('corporate_group_admin_id', $id)
    ...
    // Weekly
    public function showMyteamWeeklyGeneral(Request $request){
        $id = Auth::user()->id;
    ...
    // Monthly
    public function showMyteamMonthlyGeneral(Request $request){
        $id = Auth::user()->id;
    ...
    // Populateion
    public function showMyteamPopulationGeneral(Request $request){
        $id = Auth::user()->id;
    ...
    // Coaching
    public function showMyteamCoachingGeneral(Request $request){
        $id = Auth::user()->id;
