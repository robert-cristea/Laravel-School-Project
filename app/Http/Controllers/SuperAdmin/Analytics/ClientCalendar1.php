...
class ClientCalendar1 extends Controller 
{
    /**
    ...
    ////////////////////////////////// Client Calender /////////////////////////////
    // Engagement
    public function engageClient(Request $request){
        $dates = $request->date;
    ...
    // Populateion
    public function populationClient(Request $request){
        $dates = $request->date;
        $client_id = $request->client_id;
        $dates = explode('-', $dates);
        $start_date = $dates[0];
    ...
    // Coaching
    public function coachingClient(Request $request){
        $dates = $request->date;
        $client_id = $request->client_id;
        $dates = explode('-', $dates);
        $start_date = $dates[0];
