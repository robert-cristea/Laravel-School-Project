...
class TeamCalendar extends Controller 
{
    ...
    ////////////////////////////////// Team Calender /////////////////////////////
    // Engagement
    public function showTeamEngageGeneral(Request $request){
        $id = Auth::user()->id;
    ...
    // Weekly
    public function showTeamWeeklyGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
    ...
    // Monthly
    public function showTeamMonthlyGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
    ...
    // Populateion
    public function showTeamPopulationGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
    ...
    // Coaching
    public function showTeamCoachingGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
