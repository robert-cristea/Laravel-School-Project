...
class GeneralCalendar extends Controller 
{
    ...
    ////////////////////////////////// General Calender /////////////////////////////
    // Engagement
    public function showCorEngageGeneral(Request $request){
        $id = Auth::user()->id;
    ...
    // Weekly
    public function showCorWeeklyGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
    ...
    // Monthly
    public function showCorMonthlyGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
    ...
    // Populateion
    public function showCorPopulationGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
    ...
    // Coaching
    public function showCorCoachingGeneral(Request $request){
        $id = Auth::user()->id;
        $corporate = Corporate_clients::where('admin_id', $id)->first();
        $corporate_id = $corporate->corporate_client_id; 
  ...
  // Populateion
  public function showCorPopulationGeneralChart(Request $request){
   ...
   if($corporate){
    ...
    return response()->json([
        "high_risk" =>  $high_risk_pro,
        "moderate_risk" =>  $moderate_risk_pro,
        "low_risk" =>  $row_risk_pro,
    ]);
}
