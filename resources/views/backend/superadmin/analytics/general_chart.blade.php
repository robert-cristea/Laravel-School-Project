  ...
  <div class="card card-primary">
    <div class="card-body">
      <div class="row general-analytics-first-row">
        <div class="col-md-4"><span>{{ $general_enrolled_users }}</span> <span> enrolled users</span></div>
        <div class="col-md-4"><span>{{ $general_licence_num }}</span> <span> licenses</span></div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-body">
              <div><span>{{ round($french_users_pro) }}%</span> <span> use the App in French</span></div>
              <div><span>{{ round($english_users_pro) }}%</span> <span> use the App in English</span></div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-body">
              <div><span>{{ $week_checks }}</span> <span> weekly checks submitted</span></div>
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6"><span>{{ $video_views }}</span> <span> videos viewed</span></div>
                <div class="col-md-6"><span>{{ $video_comments }}</span> <span> interactions</span></div>
              </div>
            </div>
          </div>
        </div>
